...
<AccordionGroup>
  <Accordion title="How do I install Nuclei?">
    ...
    See the [installation guide](/installation) for other methods (Docker, binary releases, package managers).
  </Accordion>
  ...
  <Accordion title="How do I configure Nuclei?">
    ...
    See [Running Nuclei](/usage/running-scans) for configuration details.
  </Accordion>
</AccordionGroup>
